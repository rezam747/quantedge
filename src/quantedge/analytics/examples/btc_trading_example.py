...
# Automatically add src to path if running directly (not via package import)
...
from quantedge.analytics.visualization.dashboard_generator import DashboardGenerator
